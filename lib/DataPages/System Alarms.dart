...
class SystemAlarms extends StatelessWidget {
  static const String idScreen = "systemalarms" ;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        children: [
          SizedBox(height: 100,),
          Text("System Alarms", style: TextStyle(fontSize: 24.0, fontFamily: "Brand Bold" ),textAlign: TextAlign.center,),
